...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[1m\]\u:\A:\W\[\033[0m\]$(vcprompt)\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}\u:\A:\W$(vcprompt)\$ '
fi
...
#   %n  name of the VC system managing the current directory (e.g. "cvs", "hg", "git", "svn")
